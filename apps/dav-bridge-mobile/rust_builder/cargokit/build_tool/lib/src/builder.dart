...
class RustBuilder {
  ...
  Future<String> build() async {
    ...
    final rustdocPath = runCommand(
      'rustup',
      ['which', '--toolchain', _toolchain, 'rustdoc'],
    ).stdout.toString().trim();
    runCommand(
      'rustup',
      [
      ...
      // Cargo otherwise resolves `rustc` from PATH. That can mix a Homebrew
      // compiler with rustup target libraries from another toolchain.
      environment: {
