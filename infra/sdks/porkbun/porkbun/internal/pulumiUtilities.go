...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^github.com/pulumi/pulumi-terraform-provider/sdks/go/porkbun/porkbun(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	return ctx.GetOrRegisterPackageRef("porkbun:1.3.3", func() (*pulumirpc.RegisterPackageRequest, error) {
		parameter, err := base64.StdEncoding.DecodeString("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL21hcmNmcmVkZXJpY2svcG9ya2J1biIsInZlcnNpb24iOiIxLjMuMyJ9fQ==")
		if err != nil {
			return nil, err
		}
...
func PkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	...
	version := semver.MustParse("1.3.3")
